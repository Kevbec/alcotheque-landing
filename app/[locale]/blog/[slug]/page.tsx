...
const articleBodyClass = [
  ...
  "[&_li]:mb-2",
  // Tableau premium (GFM) : bordures fusionnées, ombre, en-tête marine.
  "[&_table]:w-full [&_table]:border-collapse [&_table]:rounded-2xl [&_table]:overflow-hidden",
  "[&_table]:shadow-[0_4px_32px_rgba(13,38,77,0.10)] [&_table]:my-10 [&_table]:text-sm",
  "[&_thead_tr]:bg-[#0D264D]",
  "[&_th]:px-6 [&_th]:py-4 [&_th]:text-white [&_th]:font-semibold [&_th]:text-sm [&_th]:text-center",
  "[&_th:first-child]:text-left [&_th:first-child]:rounded-tl-2xl [&_th:last-child]:rounded-tr-2xl",
  "[&_th:nth-child(2)]:bg-white/20 [&_th:nth-child(2)]:text-white [&_th:nth-child(2)]:font-bold",
  ...
  "[&_td:nth-child(2)]:bg-[#0D264D]/[0.04] [&_td:nth-child(2)]:font-semibold [&_td:nth-child(2)]:text-[#0D264D]",
