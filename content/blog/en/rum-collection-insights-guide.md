...
keywords:
  [
    "rum collection app",
    "rum collector guide",
    "agricole rum collection",
    "rum region tracker",
    "rum aging system",
    "best app rum collection",
    "rum inventory iPhone",
...
faq:
  - question: "What is the difference between agricole and industrial rum?"
    answer: "Agricole rum is distilled from fresh sugarcane juice, producing a grassy and cane-forward character. Industrial rum is made from molasses, a byproduct of sugar production, giving a richer and sweeter profile. Both are worth collecting but taste very different."
  - question: "Does sugar get added to rum?"
    answer: "Yes, many Caribbean and Latin American rums add sugar (dosage) after distillation to round out the flavor. This is not always disclosed on the label. Tracking this in your collection helps you understand your own taste preferences over time."
  - question: "What rum regions are most interesting for collectors?"
    answer: "Martinique (regulated agricole), Jamaica (high-ester pot still), Barbados (balanced blends), and Guyana (historic Demerara) are the four most distinct and collectible regions. Each produces a completely different flavor profile."
  - question: "What is a solera aging system in rum?"
    answer: "Solera is a fractional blending system where barrels are partially refilled with younger rum over time. It produces consistent house styles but makes age statements complex. Not all solera rums disclose the system on the label."
  - question: "What is the best app to track a rum collection on iPhone?"
    answer: "Alcotheque is the only iOS app that tracks rum-specific metadata including style, region, aging system, sugar content, and rarity score. It extracts this data automatically from the bottle label using AI."
---
